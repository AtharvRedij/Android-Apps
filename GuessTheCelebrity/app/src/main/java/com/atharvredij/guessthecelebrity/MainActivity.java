package com.atharvredij.guessthecelebrity;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void newQuestion() {
        try {
            ...
            Log.i("Celebrity",celebNames.get(chosenCelebrity));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button0 = findViewById(R.id.celebrity0);
        button1 = findViewById(R.id.celebrity1);
        button2 = findViewById(R.id.celebrity2);
        button3 = findViewById(R.id.celebrity3);
